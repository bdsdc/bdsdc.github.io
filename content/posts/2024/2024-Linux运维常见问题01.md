...
备份某个库mysqldump -h主机名 -u用户名 -p密码 数据库名 表名 > 文件 
备份某个库中的某个表mysqldump -u username -p --databases dbname2 dbname2 > Backup.sql 
备份多个库mysqldump -u username -p -all-databases > BackupName.sql 
